                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="AuthController.php" method="post">
                                        <div class="form-group">
                                            <input type="email" name="mail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button name="btn_login" type="submit" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
